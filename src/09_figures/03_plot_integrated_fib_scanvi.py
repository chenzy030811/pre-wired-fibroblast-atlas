"""
Publication-grade UMAP for cross-species Fibroblast — scANVI integration.
Same visual style as scVI version, for side-by-side comparison.
...
in_path  = Path("/Users/apple/Downloads/研究生毕业论文/Cross_Species/"
                "scvi_out/Fibroblast_scanvi/integrated.h5ad")
out_dir  = Path("/Users/apple/Downloads/preview_output")
out_dir.mkdir(exist_ok=True, parents=True)

# =========== palette — Reynolds/Ferreira pastel (matches KC style) ===========
SPECIES_COLORS = {
    "Reindeer": "#E28A7A",
    "Human":    "#8AB2D0",
    "Mus":      "#B5C275",
...
# stash handles for a figure-level legend at the bottom (no data overlap)
...
for i, c in enumerate(uniq_clust):
    ...
    if mask.sum() > 0:
        ...
        # plain black text, no halo, no bbox
...
# panel-mode: no suptitle, no internal a/b labels (compose script adds them)
leg = fig.legend(
    _handles, _labels,
...
out_path = out_dir / "PREVIEW_CrossSpecies_Fib_UMAP_scANVI.png"
